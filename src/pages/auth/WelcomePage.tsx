  ...
  return (
    <div className='flex w-full flex-col items-center justify-center h-full p-4 lg:p-[4rem] gap-2 lg:gap-[2rem]'>
        ...
        <div className="bg-[#F0E9F9] rounded-lg p-2 md:p-6 flex flex-col gap-3">
            ...
            <p className="text-xs lg:text-sm">This admin panel provides powerful tools and insights, giving you full control to oversee and manage your organization’s financial activities, monitor transactions, and support our user community.</p>
        </div>
